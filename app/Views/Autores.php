...
<br>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Autores Nuevo</h5>
   ...
   <table class="table table-striped table-hover">
    ...
    <tbody>
       ...
       <tr>
        ...
        <td>
                        <a href="<?= base_url('datos_autor/' .$registros['artista_id']) ?>">
                            Actualizar
                        </a>/
                        <a href="<?= base_url('eliminar_autor/' . $registros['artista_id']) ?>">
                            Eliminar
                        </a>
                    </td>
